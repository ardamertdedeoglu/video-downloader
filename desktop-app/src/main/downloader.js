    ...
    process.on("close", (code) => {
      if (code === 0) {
        ...
        if (stderr.includes("Sign in to confirm your age")) {
          reject(
            new Error(
              "Bu video yaş doğrulaması gerektiriyor. Lütfen Ayarlar'dan YouTube'a giriş yapın."
            )
          );
  ...
  const videoFormats = [
    {
      ...
      hasAudio: true,
      hasVideo: true,
      description: "Otomatik en iyi",
    },
    {
      formatId: "bv*[height<=2160]+ba/b[height<=2160]",
      quality: "4K (2160p)",
      ext: "mp4",
      hasAudio: true,
      hasVideo: true,
    ...
    {
      formatId: "bv*[height<=1440]+ba/b[height<=1440]",
      quality: "2K (1440p)",
      ext: "mp4",
      hasAudio: true,
      hasVideo: true,
    ...
    {
      formatId: "bv*[height<=480]+ba/b[height<=480]",
      quality: "480p",
      ext: "mp4",
      hasAudio: true,
      hasVideo: true,
    ...
    {
      formatId: "bv*[height<=360]+ba/b[height<=360]",
      quality: "360p",
      ext: "mp4",
      hasAudio: true,
      hasVideo: true,
  ...
  return new Promise((resolve, reject) => {
    ...
    currentProcess.on("close", (code) => {
      ...
      if (code === 0) {
        ...
        const alreadyDownloaded = stdoutOutput.includes(
        ...
        if (stderrOutput.includes("Sign in to confirm your age")) {
          errorMsg =
            "Bu video yaş doğrulaması gerektiriyor. Lütfen YouTube'a giriş yapın.";
